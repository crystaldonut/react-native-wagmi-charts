...
var _getArea = require("./utils/getArea");
...
const LineChartDimensionsContext = exports.LineChartDimensionsContext = /*#__PURE__*/_react.default.createContext({
  width: 0,
  height: 0,
  pointWidth: 0,
  parsedPath: {},
...
function LineChart({
  ...
  const {
    ...
    xLength,
    xDomain
  } = _react.default.useContext(_Context.LineChartContext);
  const {
    data
  ...
  const pointWidth = _react.default.useMemo(() => width / (data ? data.length - 1 : 1), [data, width]);
  ...
  return /*#__PURE__*/_react.default.createElement(_Data.LineChartIdProvider, {
    id: id
  }, /*#__PURE__*/_react.default.createElement(LineChartDimensionsContext.Provider, {
    value: contextValue
