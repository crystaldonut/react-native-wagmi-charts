...
const LineChartAxis = ({
  ...
  const renderTicks = () => {
    ...
    for (let i = 0; i <= tickCount; i++) {
      ...
      if (orientation === 'vertical') {
        ...
        if (strokeWidth) {
          ticks.push(/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeSvg.Line, {
            x1: x,
            y1: y,
        ...
        labels.push(/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeReanimated.default.View, {
  ...
  const renderAxis = () => {
    ...
    if (strokeWidth) {
      switch (position) {
        case 'left':
          axisLine = /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeSvg.Line, {
            x1: padding.left,
            y1: 0,
            x2: padding.left,
            y2: effectiveHeight,
