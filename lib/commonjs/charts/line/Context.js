...
var _lineChartDataPropToArray = require("./utils/lineChartDataPropToArray");
...
function LineChartProvider({
  ...
  const domain = (0, _react.useMemo)(() => (0, _getDomain.getDomain)(Array.isArray(data) ? data : Object.values(data)[0]), [data]);
  const values = (0, _react.useMemo)(() => (0, _lineChartDataPropToArray.lineChartDataPropToArray)(data).map(({
    value
  }) => value), [data]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Data.LineChartDataProvider, {
    data: data,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(LineChartContext.Provider, {
      value: contextValue,
      children: children
    })
  });
