...
exports.splitCurve = exports.pathCommandsFromString = exports.interpolatePathCommands = exports.interpolatePath = void 0;
// @ts-nocheck
 ...
 */
const pathCommandsFromString = d => {
  'worklet';
...
const interpolatePathCommands = (aCommandsInput, bCommandsInput, excludeSegment) => {
  'worklet';
...
const interpolatePath = (a, b, excludeSegment) => {
  'worklet';
