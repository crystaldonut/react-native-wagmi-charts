...
const CandlestickChartCandle = ({
  ...
  width,
  useAnimations = true,
  renderLine = props => props.useAnimations ? /*#__PURE__*/(0, _jsxRuntime.jsx)(AnimatedLine, {
    ...props
  }) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeSvg.Line, {
    ...props
  }),
  renderRect = props => props.useAnimations ? /*#__PURE__*/(0, _jsxRuntime.jsx)(AnimatedRect, {
    ...props
  ...
  const animatedLineProps = (0, _reactNativeReanimated.useAnimatedProps)(() => ({
    ...
    y1: (0, _reactNativeReanimated.withTiming)((0, _getY.getY)({
      maxHeight,
      value: low,
      domain
    })),
    x2: (0, _reactNativeReanimated.withTiming)(x + width / 2),
    y2: (0, _reactNativeReanimated.withTiming)((0, _getY.getY)({
      maxHeight,
      value: high,
      domain
    }))
  ...
  const animatedRectProps = (0, _reactNativeReanimated.useAnimatedProps)(() => ({
    ...
    y: (0, _reactNativeReanimated.withTiming)((0, _getY.getY)({
      maxHeight,
      value: max,
      domain
    })),
    height: (0, _reactNativeReanimated.withTiming)((0, _getHeight.getHeight)({
      maxHeight,
      value: max - min,
      domain
    }))
