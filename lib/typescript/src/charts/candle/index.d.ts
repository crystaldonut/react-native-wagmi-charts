...
export declare const CandlestickChart: typeof _CandlestickChart & {
    Candle: ({ candle, maxHeight, domain, margin, positiveColor, negativeColor, rectProps: overrideRectProps, lineProps: overrideLineProps, index, width, useAnimations, renderLine, renderRect, }: import("./Candle").CandlestickChartCandleProps) => any;
    ...
    Line: ({ color, x, y, ...props }: import("./Line").CandlestickChartLineProps) => any;
